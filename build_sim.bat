...
set PROJECT_NAME=csgi_sim
set C_FILE_NAME=main/main.ino

set COMPILER_OPTIONS=/nologo /Od /TP /MTd /W3 /Od /Gm- /Z7 /Fe!PROJECT_NAME!.exe
...
IF !FOUND_PATH!==0 (
	...
	set CL_PATH="cl.exe"
	set CL_OPTIONS=/nologo /Fe!EXECUTABLE_NAME! /MD /TP /W3 /Od /Zi /D_CRT_SECURE_NO_WARNINGS
